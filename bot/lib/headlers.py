...
from .settings import dp, main_text, photo_style_text, photo_source_text
...
# Todo: дописать генерацию нового фото и отправлять
